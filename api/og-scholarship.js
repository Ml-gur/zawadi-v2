...
function generateSvg({ name, provider, funding_type, deadline, countries, degree_levels, no_ielts }) {
  ...
  <!-- brand mark: Techsari T -->
  <g transform="translate(60, 48)">
    <rect x="0" y="0" width="52" height="52" rx="14" fill="#beff50"/>
    <text x="26" y="37" font-family="Arial, sans-serif" font-size="30" font-weight="700" fill="#14140f" text-anchor="middle">T</text>
  ...
  <g transform="translate(60, 140)">
    ...
    <text x="36" y="326" font-family="Arial, sans-serif" font-size="15" fill="#30302a">
      Scholarship opportunity for eligible African students.
    </text>
  </g>
  ...
  <circle cx="400" cy="584" r="4" fill="#beff50"/>
  <text x="414" y="589" font-family="Arial, sans-serif" font-size="14" fill="#6e6e64">No application fees</text>

  <circle cx="640" cy="584" r="4" fill="#beff50"/>
  <text x="654" y="589" font-family="Arial, sans-serif" font-size="14" fill="#6e6e64">Free for students</text>

  <text x="1140" y="589" font-family="Arial, sans-serif" font-size="13" fill="#919183" text-anchor="end">www.techsari.online</text>
</svg>`;
}

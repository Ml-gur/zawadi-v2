    ...
    <head>
      ...
      <style>
        ...
        @media only screen and (max-width: 600px) {
          ...
          .mobile-padding-sm { padding: 16px 20px !important; }
            ...
            <table width="100%" border="0" cellspacing="0" cellpadding="0"><tr>
              <td class="mobile-header-table"><table border="0" cellspacing="0" cellpadding="0"><tr>
                ...
                <td>
                  ...
                  <span class="mobile-font-xs" style="color:#919183;font-size:9px;font-weight:500;letter-spacing:0.12em;text-transform:uppercase;display:block;margin-top:3px;">${headerSubtitle}</span>
                </td>
              </tr></table></td>
...
function buildNewListingEmail(
  ...
  const scholarshipCards = matches.map(m => {
    ...
    const reasonsList = m.reasons.map(r => `<div class="mobile-font-sm" style="font-size:12px;color:#40403a;line-height:1.6;">✓ ${r}</div>`).join('')

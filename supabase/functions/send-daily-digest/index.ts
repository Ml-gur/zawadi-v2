...
serve(async (req: Request) => {
  ...
  try {
    ...
    for (const [userId, notifications] of byUser) {
      ...
      const scholarshipCards = topMatches.map((m: any) => {
        ...
        <head>
          ...
          <style>
            ...
            @media only screen and (max-width: 600px) {
              ...
              td.mobile-stack, .mobile-stack { display: block !important; width: 100% !important; padding: 8px 0 !important; text-align: center !important; box-sizing: border-box !important; }
              .mobile-btn { display: block !important; width: 100% !important; box-sizing: border-box !important; text-align: center !important; padding: 14px 20px !important; margin-top: 12px !important; max-width: 100% !important; }
              .mobile-header-badge, td.mobile-header-badge { display: block !important; text-align: center !important; margin-top: 10px !important; }
              .mobile-header-table td, .mobile-header-table { display: block !important; text-align: center !important; padding: 4px 0 !important; }
      ...
      const result = await sendEmail(email, `${count} scholarship${count === 1 ? '' : 's'} that may match your profile — today`, html)

        ...
        <div className="flex flex-col items-start">
          <FadeUp>
            <span className="inline-block rounded-full border border-off-black-ink px-4 py-1.5 text-ed-eyebrow uppercase text-off-black-ink">
              {countriesCount || 54} countries · every listing linked to its official source
            </span>
          </FadeUp>

          <FadeUp delay={0.08}>
            <h1 className="mt-7 text-ed-hero-sm md:text-ed-hero text-off-black-ink max-w-[12ch]">
              Your potential.<br />Funded.
            </h1>
          </FadeUp>

          <FadeUp delay={0.16}>
            <p className="mt-6 text-ed-sub font-normal text-graphite max-w-[44ch]">
              An IELTS test costs KES 31,000. A wasted application fee costs
              more. Techsari checks your passport, grades and English status
              against every verified listing — so you apply once, to grants
          ...
          <FadeUp delay={0.4}>
            <dl className="mt-10 pt-6 border-t border-ash grid grid-cols-3 gap-4 max-w-md">
              <div>
                ...
                <dt className="text-xs text-graphite mt-0.5">African passports</dt>
              </div>
              <div>
                <dd className="text-2xl sm:text-3xl font-medium tracking-tight text-off-black-ink">
              ...
              <div>
                <dd className="text-2xl sm:text-3xl font-medium tracking-tight text-off-black-ink">0%</dd>
                <dt className="text-xs text-graphite mt-0.5">AI hallucination</dt>
              </div>
            </dl>
          </FadeUp>
        </div>

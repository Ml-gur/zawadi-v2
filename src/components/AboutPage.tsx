...
/>
      <section className="px-6 py-20 md:py-24">
        <div className="max-w-[800px] mx-auto">
          ...
          <h1 className="text-3xl md:text-5xl font-display font-semibold text-cream tracking-tight mb-8">About Zawadi</h1>
          ...
          <div className="mt-12 pt-8 border-t border-hairline">
            <p className="text-base font-display font-semibold text-cream leading-relaxed">
